...
const ThemToggle = () => {
    ...
    console.log("sdfhsdkjhfjsdfew", theme.palette.themeButton.main)
  return (
        <label
            htmlFor="themeToggle"
            className="themeToggle st-sunMoonThemeToggleBtn"
            type="checkbox"
            style={{color:theme.palette.themeButton.main}}
            >
            <input onClick={handleToggleClick}  type="checkbox" id="themeToggle" className="themeToggleInput" />
            <svg
                width="25"
                height="25"
                viewBox="0 0 20 20"
